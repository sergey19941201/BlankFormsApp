...
namespace BlankFormsApp.Pages
{
    ...
    public partial class ListViewCustomReusableViewCellPage : ContentPage
    {
        public List<Phone> Phones { get; set; }
        
        public ListViewCustomReusableViewCellPage()
        {
            InitializeComponent();
            
            Phones = new List<Phone>
            {
                new Phone {Title="Galaxy S8", Company="Samsung", Price=48000, ImagePath="gorilla.png" },
                ...
                new Phone {Title="LG G 6", Company="LG", Price=42000, ImagePath="gorilla.png" },
